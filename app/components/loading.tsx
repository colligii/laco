...
export default function Loading({ firstLoading }: { firstLoading: boolean }) {
    ...
    return (
        <>
            {(isLoading || firstLoading) && (
                <div style={{ zIndex: '30000' }} className="h-screen absolute w-full z-10 flex flex-col items-center justify-center bg-[rgba(0,0,0,0.9)] text-white">
